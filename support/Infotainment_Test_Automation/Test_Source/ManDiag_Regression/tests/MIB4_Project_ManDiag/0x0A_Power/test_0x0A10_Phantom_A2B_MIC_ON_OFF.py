# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x0A10_Phantom_A2B_MIC_ON_OFF.py
# Author:       Srinivasa V
# Created:      Jan 02 2025
# Description:  This File contains Test case scenarios for validating 0x0A10 A2B_MIC ON/OFF feature.
# ------------------------------------------------------------------------------------------------------------------
...
@pytest.mark.mib4_System_0x0A10
@pytest.mark.order(181)
def test1_0x0A10_Phantom_A2B_MIC_Off_FeatureTest(ManDiag_component):
    ...
    SetCmd = "6D643E 0A 10 01 00 01 00"
    GetCmd = "6D643E 0A 10 00 00 00"
...
def test2_0x0A10_Phantom_A2B_MIC_On_FeatureTest(ManDiag_component):
    """ IOC Power mode : Phantom_A2B_MIC ON test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate Phantom_A2B_MIC ON
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn Phantom_A2B_MIC ON.          
                3. Post-condition: Send GET command to verify the OFF status.

                Expected Result:
                - The response should indicate that Phantom voltage of A2B_MIC is powered ON.
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: Phantom_A2B_MIC ON test feature Validation")
    SetCmd = "6D643E 0A 10 01 00 01 01"
    GetCmd = "6D643E 0A 10 00 00 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn ON the Phantom_A2B_MIC ")
    ...
    # Step 3: Post Condition
    app_logger.info("Executing Post Condition test: get Phantom_A2B_MIC status ")
