# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x0A03_DriverDoor_CLS_ON_OFF.py
# Author:       Srinivasa V
# Created:      Jan 02 2025
...
@pytest.mark.mib4_System_0x0A03
@pytest.mark.order(121)
def test1_0x0A03_DriverDoor_CLS_Off_FeatureTest(ManDiag_component):
    """ IOC Power mode : DriverDoor_CLS OFF test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate DriverDoor_CLS OFF
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn DriverDoor_CLS OFF.          
                3. Post-condition: Send GET command to verify the OFF status.

                Expected Result:
                - The response should indicate that Phantom voltage of DriverDoor_CLS is powered OFF.
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: DriverDoor_CLS OFF test feature Validation")
    SetCmd = "6D643E 0A 03 01 00 01 00"
    GetCmd = "6D643E 0A 03 00 00 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn OFF the DriverDoor_CLS ")
    ...
    app_logger.info("Executing Post Condition test: get DriverDoor_CLS status ")
...
def test2_0x0A03_DriverDoor_CLS_On_FeatureTest(ManDiag_component):
    """ IOC Power mode : DriverDoor_CLS ON test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate DriverDoor_CLS ON
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn DriverDoor_CLS ON.          
                3. Post-condition: Send GET command to verify the OFF status.
                ...
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: DriverDoor_CLS ON test feature Validation")
    SetCmd = "6D643E 0A 03 01 00 01 01"
    GetCmd = "6D643E 0A 03 00 00 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn ON the DriverDoor_CLS ")
