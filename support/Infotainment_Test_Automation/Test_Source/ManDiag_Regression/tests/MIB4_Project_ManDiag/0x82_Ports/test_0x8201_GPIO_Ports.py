...
@pytest.mark.order(6)
def test1_0x8201_GPIO_Ports_Control(ManDiag_component):
    """ IOC-ManDiag : GPIO Ports Control Operation test """
    ...
    SetCmd = "6D643E 82 01 01 00 03 08 07 01"
	GetCmd = "6D643E 82 01 00 00 02 08 07"
    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: SET and verify ")
    assert ManDiag_component.send_request_command_and_validate_response(SetCmd,expected_data_length="03",expected_data="08 07 01")

    # Step 3: Post Test Case
	assert ManDiag_component.send_request_command_and_validate_response(GetCmd,expected_data_length="03",expected_data="08 07 01")
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test2_0x8201_GPIO_Ports_Control(ManDiag_component):
    """ IOC-ManDiag : GPIO Ports Control Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 82 01 01 00 03 08 07 00"
	GetCmd = "6D643E 82 01 00 00 02 08 07"
    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: SET and verify ")
    assert ManDiag_component.send_request_command_and_validate_response(SetCmd,expected_data_length="03",expected_data="08 07 00")

    # Step 3: Post Test Case
	assert ManDiag_component.send_request_command_and_validate_response(GetCmd,expected_data_length="03",expected_data="08 07 00")
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test3_0x8201_GPIO_Ports_Control(ManDiag_component):
    """ IOC-ManDiag : GPIO Ports Control Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 82 01 01 00 03 08 07 00 01"
    # Step 1: Pre_Condition Test
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test4_0x8201_GPIO_Ports_Control(ManDiag_component):
    """ IOC-ManDiag : GPIO Ports Control Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 82 01 01 00 04 08 07 00 01"
    # Step 1: Pre_Condition Test
