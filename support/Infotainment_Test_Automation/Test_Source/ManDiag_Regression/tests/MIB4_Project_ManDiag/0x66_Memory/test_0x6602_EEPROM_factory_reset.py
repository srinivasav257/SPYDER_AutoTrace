...
@pytest.mark.order(6)
def test1_0x6602_EEPROM_Reset_to_default(ManDiag_component):
    """ IOC-ManDiag : EEPROM Reset to default Operation test """
    ...
    SetCmd = "6D643E 66 02 01 00 01 02"
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test2_0x6602_EEPROM_Reset_to_default(ManDiag_component):
    """ IOC-ManDiag : EEPROM Reset to default Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 66 02 01 00 01 02 00"
    # Step 1: Pre_Condition Test
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test3_0x6602_EEPROM_Reset_to_default(ManDiag_component):
    """ IOC-ManDiag : EEPROM Reset to default Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 66 02 00 00 01 02"
    # Step 1: Pre_Condition Test
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(6)
def test4_0x6602_EEPROM_Reset_to_default(ManDiag_component):
    """ IOC-ManDiag : EEPROM Reset to default Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of Turning Terminal filter ON .
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: Terminal filter ON Operation feature Validation")
    SetCmd = "6D643E 66 02 01 00 02 02 00"
    # Step 1: Pre_Condition Test
