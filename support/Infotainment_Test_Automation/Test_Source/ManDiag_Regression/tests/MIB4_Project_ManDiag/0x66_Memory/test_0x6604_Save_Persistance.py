# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x6604_Save_Persistance_Feature.py
# Author:       Srinivasa V
# Created:      JAN 1 2025
...
@pytest.mark.order(6)
def test1_0x6604_Save_Persistance(ManDiag_component):
    """ IOC-ManDiag : Save Persistance Operation test """
    ...
    SetCmd = "6D643E 66 04 01 00"
	GetCmd = "6D643E 66 04 00 00"
