# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x5104_DTC_List_Feature.py
# Author:       Srinivasa V
# Created:      Jan 02 2025
# Description:  This File contains Test case scenarios for validating DTC list feature.
# ------------------------------------------------------------------------------------------------------------------
...
def test1_0x5104_DTC_List_Feature(ManDiag_component):
    """ VIP-DTC: read Active DTCs List """
    ...
    test_description = """
         ...
         2. Actual Test: Send Get Active DTCs list and Validate the Response Valid status Byte, Data_length and Data.            
         3. Post-condition:
    ...
    app_logger.info("Starting test: DTC List feature Validation")
    ...
    assert response_data["Status"] == "01"
