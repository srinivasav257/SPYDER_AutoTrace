...
def test1_0x6401_Components_Software_ID(ManDiag_component):
    """ IOC-CAN: Components Software ID Operation test """
    ...
    GetCmd = "6D643E 64 01 00 00 01 02"
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(58)
def test2_0x7801_Components_Software_ID(ManDiag_component):
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: CAN monitoring OFF Operation feature Validation")
    GetCmd = "6D643E 64 01 00 00 01 02 00"
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(58)
def test3_0x7801_Components_Software_ID(ManDiag_component):
    """ IOC-CAN: CAN Dummy msg for MIB_CAN Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of start sending Dummy message for MIB_CAN.
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: CAN monitoring OFF Operation feature Validation")
    GetCmd = "6D643E 64 01 00 00 02 02 00"
...
# @pytest.mark.skip(reason="disabling just for debugging purpose")
@pytest.mark.order(58)
def test4_0x7801_Components_Software_ID(ManDiag_component):
    """ IOC-CAN: CAN Dummy msg for MIB_CAN Operation test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: This test case verifies the functionality of start sending Dummy message for MIB_CAN.
    ...
    app_logger.info(test_description)
    app_logger.info("Starting test: CAN monitoring OFF Operation feature Validation")
    GetCmd = "6D643E 64 01 01 00 01 02"
