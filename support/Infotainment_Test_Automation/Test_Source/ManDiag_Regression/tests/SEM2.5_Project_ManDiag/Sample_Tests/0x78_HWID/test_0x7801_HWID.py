# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x7801_HWID.py
# Author:       Srinivasa V
# Created:      Aug 29 2025
# Description:  This File contains Test case scenarios for validating 0x7801 Hardware ID.
# ------------------------------------------------------------------------------------------------------------------
...
#@pytest.mark.order(7)
def test1_0x7801_HWID(ManDiag_component):
    """ HWID Test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate Hardware ID
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send GET command to Get Hardware ID.          
                3. Post-condition:

                Expected Result:
                - The response should indicate that Hardware ID of the component is returned successfully.
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: Get Hardware ID test feature Validation")
    GetCmd = "6D643E 78 01 00 00 01 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Get Hardware ID ")
