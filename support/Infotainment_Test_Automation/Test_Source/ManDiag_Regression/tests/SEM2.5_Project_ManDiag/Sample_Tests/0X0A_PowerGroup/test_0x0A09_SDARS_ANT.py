# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x0A09_SDARS_ANT.py
# Author:       Srinivasa V
# Created:      Aug 25 2025
# Description:  This File contains Test case scenarios for validating 0x0A09 SDARS Antenna Phantom ON/OFF feature.
# ------------------------------------------------------------------------------------------------------------------
...
#@pytest.mark.order(7)
def test1_0x0A09_SDARS_ANT(ManDiag_component):
    """ SDARS Antenna OFF test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate SDARS Antenna OFF
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn SDARS Antenna OFF.          
                3. Post-condition: Send GET command to verify the OFF status.

                Expected Result:
                - The response should indicate that SDARS Antenna is powered OFF.
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: SDARS Antenna OFF test feature Validation")
    ...
    app_logger.info("Executing actual test: Turn OFF SDARS Antenna ")
    ...
    app_logger.info("Executing Post Condition test: Get SDARS Antenna status ")
...
# @pytest.mark.skip(reason="Enable this line for Skipping this test case")
#@pytest.mark.order(8)
def test2_0x0A09_SDARS_ANT(ManDiag_component):
    """ SDARS Antenna ON test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate SDARS Antenna ON
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn SDARS Antenna ON.          
                3. Post-condition: Send GET command to verify the ON status.

                Expected Result:
                - The response should indicate that SDARS Antenna is powered ON.
                """
    app_logger.debug(test_description)
    ...
    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn ON SDARS Antenna ")
