# ------------------------------------------------------------------------------------------------------------------
# File Name:    test_0x0A0C_CAM.py
# Author:       Srinivasa V
# Created:      Aug 26 2025
# Description:  This File contains Test case scenarios for validating 0x0A0C CAM ON/OFF feature.
# ------------------------------------------------------------------------------------------------------------------
...
#@pytest.mark.order(7)
def test1_0x0A0C_CAM(ManDiag_component):
    """ CAM OFF test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate CAM OFF
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn CAM OFF.          
                3. Post-condition: Send GET command to verify the OFF status.

                Expected Result:
                - The response should indicate that CAM is powered OFF.
                """
    app_logger.debug(test_description)
    app_logger.info("Starting test: CAM OFF test feature Validation")
    SetCmd = "6D643E 0A 0C 01 00 01 00"
    GetCmd = "6D643E 0A 0C 00 00 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn OFF CAM ")
    ...
    app_logger.info("Executing Post Condition test: Get CAM status ")
...
# @pytest.mark.skip(reason="Enable this line for Skipping this test case")
#@pytest.mark.order(8)
def test2_0x0A0C_CAM(ManDiag_component):
    """ CAM ON test """
    # Step 0: Update the Test variable and Test Procedure
    test_description = """
                Test Case: Validate CAM ON
                Steps:
                1. Pre-condition: The Unit should be powered ON and VIP must be fully BootUp and Running.
                2. Actual Test: Send SET power Enable/Disable command to turn CAM ON.          
                3. Post-condition: Send GET command to verify the ON status.

                Expected Result:
                - The response should indicate that CAM is powered ON.
                """
    app_logger.debug(test_description)
    SetCmd = "6D643E 0A 0C 01 00 01 01"
    GetCmd = "6D643E 0A 0C 00 00 00"

    # Step 1: Pre_Condition Test

    # Step 2: Actual Test Case
    app_logger.info("Executing actual test: Turn ON CAM ")
