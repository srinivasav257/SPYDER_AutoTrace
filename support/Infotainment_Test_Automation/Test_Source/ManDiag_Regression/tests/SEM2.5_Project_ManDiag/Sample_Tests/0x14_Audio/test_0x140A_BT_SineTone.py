...
def test1_0x140A_BT_SineTone(ManDiag_component):
    ...
    test_description = """
                ...
                3. Post-condition: Send GET command to GET BT Sine Tone Test Status.
    ...
    SetCmd = "6D643E 14 0A 01 00 01 01"
    GetCmd = "6D643E 14 0A 00 00 00"
    ...
    app_logger.info("Executing actual test: Get BT Sine Tone Test Status ")
    assert ManDiag_component.send_request_command_and_validate_response(GetCmd, expected_status="AA", retries=5)
